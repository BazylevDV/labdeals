...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("bot.log", encoding='utf-8'),  # Логи будут записываться в файл с кодировкой UTF-8
...
equipment_data = {
    "🟦 Анализатор мочи автоматический H-500, DIRUI, КНР": {
        ...
        "description": (
            ...
            "Cамая низкая цена на рынке на тест-полоски."
        ),
        "conditions": (
    ...
    "🟩 Анализатор автоматический иммунохемилюминесцентный для диагностики in vitro Maglumi 800, КНР": {
        ...
        "description": (
            ...
            "Самая широкая линейка зарегистрированных тестов на рынке РФ."
        ),
        "conditions": (
            "📜 *Условия предоставления:*\n"
            "1. 🆓 Оборудование предоставляется бесплатно на условиях демонстрационного пользования или аренды.\n"
    ...
    "🟨 Анализатор иммунофлуоресцентный Finecare FIA FS-113, Wondfo, КНР": {
        ...
        "description": (
            ...
            " Ваш рациональный выбор по критериям  экономия/качество."
        ),
        "conditions": (
            "📜 *Условия предоставления:*\n"
            "1. 🆓 Оборудование предоставляется бесплатно на условиях демонстрационного пользования или аренды.\n"
...
async def start(message: types.Message):
    ...
    welcome_text = (
        ...
        "Здесь вы сможете:\n"
        "• 🆓 Рационально пополнить парк лабораторного оборудования ,жми *Бесплатное оборудование*.\n"
        "• ℹ️ Оперативно достичь своих целей позвонив или написав нам, жми * О нас*.\n"
        "• 🧪 Ознакомиться с cамым широким на рынке РФ  меню иммунохелюминесцентных тестов ,жми *Меню тестов к анализаторам Maglumi*.\n"  # Обновленный текст
        "• 🔥 Съкономить бюджет ознакомившись с файлом *Ликвидация склада реагентов и медизделий*.\n\n"
        "👇 *Выберите опцию ниже:*"
    )
